...
description: Recover weak or decayed pages end to end, with a quality gate before relaunch. Pulls site-audit findings from SE Ranking, prioritizes the pages worth fixing, drafts the rewritten copy in a Planable Universal page for stakeholder comments and approval, runs a relaunch quality gate (E-E-A-T and citability checklist) on the approved copy, refreshes internal links, and schedules the supporting social distribution with a post-fix measurement plan. Use whenever the user wants weak pages fixed, approved, and relaunched — "fix and relaunch these pages", "page recovery", "coordinate a content refresh with approval", "weak pages action plan", "our page lost traffic, fix it properly". Requires the SE Ranking and Planable MCPs. For fix-plus-distribution without the relaunch gate and measurement, use site-audit-to-social-distribution from Planable/smm-skills instead.
---
